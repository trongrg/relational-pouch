...
exports.setSchema = function (schema) {
  ...
  function _bulkSave(type, objs) {
    ...
    return Promise.resolve().then(function () {
      ...
      var res = objs.map(function(obj, index) {
        var doc = pouchRes[index];
        return extend(true, obj, {
          id: deserialize(doc.id + ''),
          rev: doc.rev
        });
      });
      return res;
  ...
  function _find(type, idOrIds, foundObjects) {
    ...
    if (typeof idOrIds === 'undefined' || idOrIds === null) {
      ...
      if (typeof idOrIds.attachments !== 'undefined' && idOrIds.attachments !== null) {
        opts.attachments = idOrIds.attachments;
      }
    } else {
    // find by single id
